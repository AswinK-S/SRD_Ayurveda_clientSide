...
const Body = () => {
    return (
        <>
            <div className="container border flex-col p-10 mb-16 ">
                <div className="flex-container justify-evenly items-center p-2 shadow-2xl rounded-3xl mt-5 h-2/4 w-[80rem]" >
                    <div className='m-4'>
                        <img className='rounded-3xl img-fluid h-[400px] w-[500px] hoverable cursor-pointer shadow-lg' src="/product-bg.jpg" alt="" />
                    </div>

                    <div className='border border-b-2 p-4 bg-[#E7EE9D] rounded-3xl shadow-lg h-full m-4  w-3/6 '>
                ...
                <div className="flex-container justify-evenly items-center p-2 h-2/4 shadow-2xl rounded-3xl mt-5 w-[80rem]">
                    <div className='border border-b-2 p-4 bg-[#E7EE9D] rounded-3xl shadow-lg h-full m-4  w-3/6 '>
