...
const BookTrtmnt = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row bg-[#e5ed83] m-10 p-5 shadow-md shadow-black rounded-lg">
            {/* Left side */}
            ...
            <div className="flex-1 p-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="mb-4 p-2  max-h-80 flex flex-col items-center rounded-lg bg-[#eff6d5] overflow-hidden">
                        <div className="w-3/4 max-w-md overflow-y-scroll p-3">
                            {slots.map((slot) => (
                                <Card key={slot.id} className="mt-6 w-auto bg-gradient-to-r from-lime-300 via-lime-100 to-lime-300 shadow-md shadow-black">
                                    <CardBody>
